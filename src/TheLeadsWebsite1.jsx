            ...
            <div style={{ padding: "40px", background: "linear-gradient(135deg,rgba(37,99,235,0.1),rgba(124,58,237,0.1))", border: "1px solid rgba(139,92,246,0.3)", borderRadius: 24, backdropFilter: "blur(12px)" }}>
              ...
              <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap" }}>
                ...
                <motion.a href="https://wa.me/919986693238" target="_blank" rel="noopener noreferrer"
                  whileHover={{ scale: 1.05, boxShadow: "0 0 40px rgba(37,211,102,0.6)" }}
                  whileTap={{ scale: .97 }}
                  style={{ background: "linear-gradient(135deg,#25D366,#16a34a)", color: "#fff", border: "none", borderRadius: 12, padding: "16px 40px", fontSize: 16, fontWeight: 800, cursor: "pointer", fontFamily: "inherit", textDecoration: "none", display: "inline-flex", alignItems: "center", gap: 10, boxShadow: "0 0 24px rgba(37,211,102,0.35)", position: "relative", overflow: "hidden" }}>
                  <motion.div animate={{ scale: [1, 1.4, 1], opacity: [0.4, 0, 0.4] }} transition={{ repeat: Infinity, duration: 2 }}
                    style={{ position: "absolute", inset: 0, borderRadius: 12, background: "rgba(37,211,102,0.3)" }} />
            ...
            {submitted ? (
              ...
              <motion.div style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.08)", borderRadius: 22, padding: "44px 38px", backdropFilter: "blur(20px)", boxShadow: "0 0 60px rgba(59,130,246,0.08)" }}>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <motion.button whileHover={{ scale: submitting ? 1 : 1.02, boxShadow: submitting ? "none" : "0 0 40px rgba(37,211,102,0.5)" }} whileTap={{ scale: submitting ? 1 : .98 }} type="submit" disabled={submitting}
                    style={{ width: "100%", background: submitting ? "rgba(255,255,255,0.1)" : "linear-gradient(135deg,#25D366,#16a34a)", color: "#fff", border: "none", borderRadius: 11, padding: "17px", fontSize: 16, fontWeight: 800, cursor: submitting ? "not-allowed" : "pointer", fontFamily: "inherit", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, boxShadow: submitting ? "none" : "0 0 24px rgba(37,211,102,0.3)" }}>
                    {submitting ? "⏳ Sending..." : (
                      <>
